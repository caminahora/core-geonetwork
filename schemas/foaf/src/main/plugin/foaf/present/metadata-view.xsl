...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- ===================================================================== -->
  <xsl:template name="view-with-header-foaf">
		<xsl:param name="tabs"/>
  ...
  <xsl:template name="metadata-foafview-simple" match="metadata-foafview-simple">
		<xsl:call-template name="view-with-header-foaf">
			<xsl:with-param name="tabs">

			<xsl:call-template name="complexElementSimpleGui">
				<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/siteIdentification"/>
				...
				<xsl:call-template name="complexElementSimpleGui">
					...
					<xsl:with-param name="content">
						...
						<!-- Metadata identifier -->
     				<xsl:apply-templates mode="simpleElement-foaf" select="sml:member/sml:System/sml:identification/sml:IdentifierList/sml:identifier[@name='GeoNetwork-UUID' or @name=$ogcID]">
							<xsl:with-param name="id" select="'GeoNetwork-UUID'"/>
						</xsl:apply-templates>
   		 
						<!-- Effective date -->
      			<xsl:apply-templates mode="simpleElement-foaf" select="sml:member/sml:System/sml:validTime/gml:TimeInstant/gml:timePosition"/>
		
						<!-- Abstract -->
     				<xsl:apply-templates mode="simpleElement-foaf" select="sml:member/sml:System/gml:description">
							<xsl:with-param name="id"     select="'abstract'"/>
						</xsl:apply-templates>
	
						<!-- Site Status -->
     				<xsl:apply-templates mode="simpleElement-foaf"
				...
				<!-- Contact Information -->
				<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:contact/sml:ContactList/sml:member/sml:ResponsibleParty|sml:member/sml:System/sml:contact/sml:ResponsibleParty"/>

				<!-- InputList -->
				<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:inputs/sml:InputList"/>
	
				<!-- Point location of sensor site -->
				<xsl:call-template name="complexElementSimpleGui">
					<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/pointLocation"/>
					<xsl:with-param name="content">
	
						<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:position/swe:Position">
				...
				<xsl:call-template name="complexElementSimpleGui">
					<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/observationBoundingBox"/>
					<xsl:with-param name="content">
	
						<xsl:apply-templates mode="foaf" select="sml:member/sml:System/sml:capabilities/swe:DataRecord/swe:field[@name='observedBBOX']">
				...
				<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:history/sml:EventList/sml:member/sml:Event"/>
	
				<!-- Documents relating to/about site -->
				<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:documentation/sml:DocumentList/sml:member/sml:Document"/>

				<!-- IdentifierList -->
				<xsl:call-template name="complexElementSimpleGui">
					<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/identifiers"/>
					<xsl:with-param name="content">
						<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:identification/sml:IdentifierList/sml:identifier[@name!='GeoNetwork-UUID' and @name!=$ogcID]"/>
					</xsl:with-param>
 				</xsl:call-template> 

				<!-- ClassifierList -->
				<xsl:call-template name="complexElementSimpleGui">
					<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/classifiers"/>
					<xsl:with-param name="content">
						<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:classification/sml:ClassifierList/sml:classifier"/>
					</xsl:with-param>
 				</xsl:call-template> 
	
				<!-- Keywords -->
				<xsl:call-template name="complexElementSimpleGui">
					<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/keywords"/>
					<xsl:with-param name="content">
						<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:keywords/sml:KeywordList/sml:keyword"/>
					</xsl:with-param>
 				</xsl:call-template> 

				<!-- Component sensors deployed at this site -->
				<xsl:apply-templates mode="block-foaf" select="sml:member/sml:System/sml:components/sml:ComponentList/sml:component/sml:Component"/>
    ...
    </xsl:call-template> <!-- view-with-header-foaf -->
  </xsl:template>
    ...
    <xsl:apply-templates mode="simpleElement-foaf" select="sml:Term/sml:value">
    ...
    <xsl:apply-templates mode="simpleElement-foaf" select="swe:ObservableProperty">
			<xsl:with-param name="name"   select="name()"/>
  ...
  <xsl:template mode="simpleElement-foaf" match="*|@*">
	...
	<xsl:template mode="block-foaf" match="sml:InputList">

		<xsl:call-template name="complexElementSimpleGui">
			<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/inputs"/>
			<xsl:with-param name="content">
	...
	<xsl:template mode="block-foaf" match="sml:ResponsibleParty">
	...
	<xsl:template mode="block-foaf" match="swe:Position">
		<xsl:param name="suffix"/>
	...
	<xsl:template mode="block-foaf" match="swe:coordinate">
		<xsl:param name="suffix"/>
		
   	<xsl:apply-templates mode="simpleElement-foaf" select="swe:Quantity/swe:value">
			<xsl:with-param name="name"   select="name()"/>
	...
	<xsl:template mode="block-foaf" match="sml:Event">
	...
	<xsl:template mode="block-foaf" match="sml:Component">

		<xsl:call-template name="complexElementSimpleGui">
			<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/component"/>
			<xsl:with-param name="content">

				<xsl:variable name="link" select="normalize-space(../@xlink:href)"/>
				<xsl:choose>
					<xsl:when test="$link!=''">
   					<xsl:apply-templates mode="simpleElement-foaf" select="../@xlink:href">
						</xsl:apply-templates>
					</xsl:when>
					<xsl:otherwise>
						...
						<!-- Sensor Info -->
						<xsl:call-template name="complexElementSimpleGui">
							<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/sensorInfo"/>
							<xsl:with-param name="content">
								<!-- Sensor Description -->
     						<xsl:apply-templates mode="simpleElement-foaf" select="gml:description">
								</xsl:apply-templates>
						...
						<xsl:call-template name="complexElementSimpleGui">
							<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/identifiers"/>
							<xsl:with-param name="content">
								<xsl:apply-templates mode="block-foaf" select="sml:identification/sml:IdentifierList/sml:identifier">
								</xsl:apply-templates>
							</xsl:with-param>
   					</xsl:call-template> 
						...
						<xsl:call-template name="complexElementSimpleGui">
							<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/classifiers"/>
							<xsl:with-param name="content">
								<xsl:apply-templates mode="block-foaf" select="sml:classification/sml:ClassifierList/sml:classifier">
								</xsl:apply-templates>
							</xsl:with-param>
   					</xsl:call-template> 
						...
						<xsl:call-template name="complexElementSimpleGui">
							<xsl:with-param name="title" select="/root/gui/schemas/foaf/strings/keywords"/>
							<xsl:with-param name="content">
								<xsl:apply-templates mode="block-foaf" select="sml:keywords/sml:KeywordList/sml:keyword">
								</xsl:apply-templates>
							</xsl:with-param>
   					</xsl:call-template> 
						...
						<xsl:call-template name="complexElementSimpleGui">
							...
							<xsl:with-param name="content">
								...
								<xsl:apply-templates mode="block-foaf" select="sml:position/swe:Position">
						...
						<xsl:call-template name="complexElementSimpleGui">
							...
							<xsl:with-param name="content">
								...
								<xsl:apply-templates mode="foaf" select="sml:capabilities/swe:DataRecord/swe:field[@name='observedBBOX']">
									<xsl:with-param name="schema" select="$schema"/>
									<xsl:with-param name="edit" select="false()"/>
								</xsl:apply-templates>
	...
	<xsl:template	mode="block-foaf" match="sml:Document">
	...
	<xsl:template mode="block-foaf" match="sml:identifier[@name!='GeoNetwork-UUID' and @name!=$ogcID]">
	...
	<xsl:template mode="block-foaf" match="sml:classifier">
	...
	<xsl:template mode="block-foaf" match="sml:keyword">

 		<xsl:apply-templates mode="simpleElement-foaf" select=".">
